...
export default function MOUVault() {
  ...
  const filteredItems = useMemo(() => {
    ...
    switch (sortBy) {
      ...
      case "vendor":
        ...
        break;
      default:
        // Already sorted by recent from the hook
        break;
    }
  ...
  if (isLoading) {
    return (
      <DashboardLayout title="MOU Vault" subtitle="Secure document storage with automated extraction">
